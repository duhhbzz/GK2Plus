...
<p align="center">
  ...
  <img alt="Tested GK2 version" src="https://img.shields.io/badge/GK2%20tested-1.005-success">
...
**Compatibility:** GK2+ v0.1.0 has been runtime-tested against **Graveyard Keeper 2 v1.005**. If the game updates, GK2+ reports the running game version as untested but continues loading so minor game patches do not create an unnecessary hard lock.
